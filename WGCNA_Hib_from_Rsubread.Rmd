...
Haemophilus_influenzae_10810_GCF_000210875_1_proteintable <- read_delim("/home/jaque/Downloads/Haemophilus_influenzae_10810.GCF_000210875.1.proteintable.txt", "\t", escape_double = FALSE, trim_ws = TRUE)
...
RefSeqgff <- gffRead("/home/jaque/Downloads/GCF_000210875.1_ASM21087v1_genomic.gff")
...
Rsubread_Count_Renamed_noRNA_table = read.csv("/home/jaque/Downloads/Rsubread_Count_Table_Renamed_without_rRNA.csv", header = TRUE, sep = "\t", row.names = 1)
...
HibPP = lapply(6:8, function(i){read.csv(paste0("/home/jaque/Downloads/HibPP0", i, "-16.csv"), dec = ",",  sep = "\t", header = TRUE, quote = "")})
HibPP[[4]] = read.csv("/home/jaque/Downloads/HibPP02-17.csv", dec = ",", header=TRUE, sep="\t", quote="")
