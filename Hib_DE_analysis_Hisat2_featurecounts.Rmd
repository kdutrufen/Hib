...
barplot = ggplot(data=sumdata, aes(x=Samples, y=Counts, fill=Samples)) + geom_bar(colour="black", stat="identity", fill = c("yellow", col.cell) )
barplot = barplot + theme(axis.text.x = element_text(angle = 90, hjust = 1))
barplot + geom_hline(mapping = NULL, data = NULL, yintercept = 2e+06, na.rm = FALSE, show.legend = NA, colour="black")
```
...
myCPM = cpm(d)
cpm(10, mean(d$samples$lib.size))
CPMthershold = round(cpm(10, mean(d$samples$lib.size)), digits=2)
```
...
edgeR_DEGs = list(S01xS02 = edgeRDEnames[[1]], S01xS03 = edgeRDEnames[[2]], S01xS04 = edgeRDEnames[[3]], S01xS05 = edgeRDEnames[[4]], S01xS06 = edgeRDEnames[[5]], S02xS03 = edgeRDEnames[[6]], S02xS04 = edgeRDEnames[[7]], S02xS05 = edgeRDEnames[[8]], S02xS06 = edgeRDEnames[[9]], S03xS04 = edgeRDEnames[[10]], S03xS05 = edgeRDEnames[[11]], S03xS06 = edgeRDEnames[[12]], S04xS05 = edgeRDEnames[[13]], S04xS06 = edgeRDEnames[[14]], S05xS06 = edgeRDEnames[[15]])
