...
DESeqresults[[1]] <- results(dds, contrast = c("condition", "S02", "S01"))
DESeqresults[[2]] <- results(dds, contrast = c("condition", "S03", "S01"))
DESeqresults[[3]] <- results(dds, contrast = c("condition", "S04", "S01"))
DESeqresults[[4]] <- results(dds, contrast = c("condition", "S05", "S01"))
DESeqresults[[5]] <- results(dds, contrast = c("condition", "S06", "S01"))
DESeqresults[[6]] <- results(dds, contrast = c("condition", "S03", "S02"))
DESeqresults[[7]] <- results(dds, contrast = c("condition", "S04", "S02"))
DESeqresults[[8]] <- results(dds, contrast = c("condition", "S05", "S02"))
DESeqresults[[9]] <- results(dds, contrast = c("condition", "S06", "S02"))
DESeqresults[[10]] <- results(dds, contrast = c("condition", "S04", "S03"))
DESeqresults[[11]] <- results(dds, contrast = c("condition", "S05", "S03"))
DESeqresults[[12]] <- results(dds, contrast = c("condition", "S06", "S03"))
DESeqresults[[13]] <- results(dds, contrast = c("condition", "S05", "S04"))
DESeqresults[[14]] <- results(dds, contrast = c("condition", "S06", "S04"))
DESeqresults[[15]] <- results(dds, contrast = c("condition", "S06", "S05"))
...
KEGG_DEGs_df <- KEGG_DEGs %>% as.data.frame()

KEGG_DEGs_df$geneID <- KEGG_DEGs_df %>% order_genes("geneID")
